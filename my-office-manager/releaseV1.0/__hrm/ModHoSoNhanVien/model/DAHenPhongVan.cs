    ...
    public class DAHenPhongVan
    {
        public static bool InsertKhongDat(DOHenPhongVan HenPhongVan)
        {
            try
            {
                ...
                + "("
                    + "ID,R_ID,NGAY_GIO_PHONG_VAN,GIO_PHONG_VAN,VONG_PHONG_VAN,LAN_MOI_PHONG_VAN,MOI_PHONG_VAN,"
                ...
                db.AddInParameter(cmd, "@GIO_PHONG_VAN", DbType.Time, HenPhongVan.GIO_PHONG_VAN);    
        ...
        public static DOHenPhongVan getHenPhongVan_NOTD(long R_ID)
        {
            ...
            DataSet ds = HelpDB.getDatabase().LoadDataSet(query, "AA");
            ...
            if (ds.Tables[0].Rows[0]["GIO_PHONG_VAN"].ToString().Length > 0)
                HenPhongVan.GIO_PHONG_VAN = (TimeSpan?)ds.Tables[0].Rows[0]["GIO_PHONG_VAN"];
