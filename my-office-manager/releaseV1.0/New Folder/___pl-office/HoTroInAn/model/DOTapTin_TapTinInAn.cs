...
namespace DTO
{
    public class DOTapTin_TapTinInAn : DOPhieu
    {
        ...
        private long _HO_TRO_IN_AN_ID;
        private decimal _SO_TO;
        private string _YEU_CAU;
        #endregion

        #region Khởi tạo đối tượng
        public DOTapTin_TapTinInAn() { }
        public DOTapTin_TapTinInAn(long ID, string TIEU_DE, string TEN_FILE, byte[] NOI_DUNG, 
                        long NGUOI_CAP_NHAT, DateTime NGAY_CAP_NHAT, string GHI_CHU,
                        long HO_TRO_IN_AN_ID,decimal SO_TO,string YEU_CAU ) 
        {
            this._ID = ID;
            ...
            this._HO_TRO_IN_AN_ID=HO_TRO_IN_AN_ID;
        ...
        public long HO_TRO_IN_AN_ID
        {
            get { return _HO_TRO_IN_AN_ID; }
            set { _HO_TRO_IN_AN_ID = value; }
        }
        public long GetHO_TRO_IN_AN_ID() { return this._HO_TRO_IN_AN_ID; }
