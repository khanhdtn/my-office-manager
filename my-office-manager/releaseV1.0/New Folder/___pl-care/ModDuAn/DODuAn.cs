...
namespace DTO
{
    public class DODuAn:DOPhieu
    {
        ...
        private decimal _TIEN_DO;

        public decimal TIEN_DO
        {
            get { return _TIEN_DO; }
            set { _TIEN_DO = value; }
        }
        public decimal GetTIEN_DO() { return _TIEN_DO; }
        ...
        private DateTime? _NGAY_KET_THUC_THUC_TE;

        public DateTime? NGAY_KET_THUC_THUC_TE {
            get { return _NGAY_KET_THUC_THUC_TE; }
            set { _NGAY_KET_THUC_THUC_TE = value; }
        }

        public DateTime? GetNGAY_KET_THUC_THUC_TE() { return _NGAY_KET_THUC_THUC_TE; }
        #endregion

        #region Các hàm khởi tạo 
        public DODuAn() { }
        public DODuAn(long ID, string Name, long Loai_du_an, long Nguoi_quan_ly, DateTime Ngay_bat_dau, DateTime Ngay_ket_thuc, decimal Tien_do, long Muc_uu_tien
            ,long Tinh_trang,string Mo_ta,string Thong_tin_them, string Nguoi_thuc_hien,DateTime? Ngay_ket_thuc_thuc_te)
        {
            _ID = ID;
            _NAME = Name;
            ...
            _NGUOI_THUC_HIEN = Nguoi_thuc_hien;
            _NGAY_KET_THUC_THUC_TE = Ngay_ket_thuc_thuc_te;
        }
        #endregion
    }   
}
