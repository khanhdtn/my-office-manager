...
namespace DTO
{
    public class DODanhBaExt : DOPhieu
    {
        private long _ID;
        ...
        {
            get { return _TEN_NGAN_HANG; }
            set { _SO_DIEN_THOAI = value; }
        }
        public string GetSO_CMND() { return _TEN_NGAN_HANG; }
        ...
        public string GetBO_PHAN() { return _DI_DONG; }
        ...
        )
        {
            ...
            this._TEN_NGAN_HANG = CMND;
            this._SO_FAX = FAX;
            this._NGUOI_DAI_DIEN = NGUOI_DAI_DIEN;
            this.CHUC_VU = CHUC_VU;
            this._DI_DONG = BO_PHAN;
